...
export interface KdfOpensearchProps
  extends StackProps,
    Omit<
...
export class KdfOpensearchStack extends Stack {
  constructor(scope: Construct, id: string, props: KdfOpensearchProps) {
    super(scope, id, props);

    //names have to be lowercase only
    ...
    //outputs
    new CfnOutput(this, `${kdfDeliveryStreamOutputName}Name`, {
      value: deliveryStream.ref,
    });
    new CfnOutput(this, `${kdfDeliveryStreamOutputName}Arn`, {
      value: deliveryStream.getAtt('Arn').toString(),
    });
